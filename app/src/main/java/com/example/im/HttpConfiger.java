...
public class HttpConfiger {
    ...
    /* local url */
    private static final String localUrl = "http://10.0.0.4:8080/apiv1";

    /* test url */
    private static final String testUrl = "http://192.168.144.81:8080/apiv1";

    private static final String url = BuildConfig.HOST;
